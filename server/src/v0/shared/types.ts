export interface V0ThreadConfigRecord {
  id: number;
  threadUrl: string;
  threadTitle: string;
  ngaCookie: string;
...
export interface V0AuthorWatchRecord {
  id: number;
  authorName: string;
  alias: string | null;
  enabled: boolean;
...
export interface V0ConfigPayload {
  threadUrl?: string;
  threadTitle?: string;
  ngaCookie?: string;
  pollIntervalSeconds?: number;
...
export interface V0ParsedForumMessage {
  floorId: string;
  authorName: string;
  postedAt: string;
  rawContent: string;
...
export interface V0StoredForumMessage extends V0ParsedForumMessage {
  id: number;
  threadKey: string;
  contentHash: string;
  isNew: boolean;
...
export interface V0PollResponse {
  threadUrl: string;
  threadTitle: string;
  matchedAuthorCount: number;
  totalMessages: number;
  matchedMessages: V0ParsedForumMessage[];
...
export interface V0DigestBuildPayload {
  digestDate?: string;
}
...
export interface V0PersonaChunkRecord {
  id: number;
  messageId: number;
  threadKey: string;
  floorId: string;
...
export interface V0PersonaEmbeddingRecord {
  id: number;
  chunkId: number;
  modelName: string;
...
export interface V0AgentQueryPayload {
  query: string;
  debug?: boolean;
}
...
export interface V0MarketFactsPayload {
  queryDate?: string;
  stocks?: string[];
  sectors?: string[];
...
export interface V0ExternalMarketFactsPayload {
  queryDate?: string;
...
export interface V0AgentQueryResponse {
  queryType:
...
export interface V0JobStatusResponse {
  threadUrl: string;
  threadTitle: string;
  enabled: boolean;
  pushEnabled: boolean;
